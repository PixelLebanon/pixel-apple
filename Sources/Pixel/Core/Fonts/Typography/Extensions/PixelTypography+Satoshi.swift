...
private extension SatoshiPixelFont {
    ...
    static let superDino1: Self = .init(size: 50, style: .largeTitle)
    static let superDino2: Self = .init(size: 44, style: .largeTitle)
    static let superDino3: Self = .init(size: 40, style: .largeTitle)
    static let superDino4: Self = .init(size: 40, style: .largeTitle)
    static let superDino5: Self = .init(size: 36, style: .largeTitle)

    static let dino1: Self = .init(size: 36, style: .largeTitle)
    static let dino2: Self = .init(size: 32, style: .largeTitle)
    static let dino3: Self = .init(size: 30, style: .title)
    static let dino4: Self = .init(size: 30, style: .title)
    static let dino5: Self = .init(size: 28, style: .title)

    static let big1: Self = .init(size: 28, style: .title)
    static let big2: Self = .init(size: 24, style: .title2)
    static let big3: Self = .init(size: 22, style: .title2)
    static let big4: Self = .init(size: 22, style: .title2)
    static let big5: Self = .init(size: 20, style: .title3)
    ...
    static let medium4: Self = .init(size: 16, style: .body)
    static let medium5: Self = .init(size: 14, style: .subheadline)

    static let small1: Self = .init(size: 14, style: .subheadline)
    static let small2: Self = .init(size: 13, style: .footnote)
    static let small3: Self = .init(size: 12, style: .caption)
    static let small4: Self = .init(size: 12, style: .caption)
    static let small5: Self = .init(size: 11, style: .caption2)

    static let superSmall1: Self = .init(size: 11, style: .caption2)
    static let superSmall2: Self = .init(size: 10, style: .caption2)
    static let superSmall3: Self = .init(size: 10, style: .caption2)
    static let superSmall4: Self = .init(size: 10, style: .caption2)
    static let superSmall5: Self = .init(size: 9, style: .caption2)
}
